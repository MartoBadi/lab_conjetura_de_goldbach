...
CONFIG = {
    ...
    "n_final": 10**17,                  # Último número a verificar (1 billón)
...
📊 PROGRESO:
   ...
   • Porcentaje completado: {porcentaje:.4f}%
...
╚═══════════════════════════════════════════════════════════════╝
    ...
    estimacion_simple = CONFIG["n_final"] / (CONFIG["num_cores"] * 1000)  # muy aproximado
